"""Dependency Injection container wiring hexagonal ports and adapters for DPX-C."""
...
class Container:
    """IoC container managing singleton services and adapters for DPX-C."""
    ...
    def parser(self) -> ParserPort:
        if self._parser is None:
            self._parser = NativeCParserAdapter()
        return self._parser
