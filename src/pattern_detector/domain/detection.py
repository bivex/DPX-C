"""Detection and Report domain entities for C Pattern Detector."""
...
class Detection:
    """Represents an identified C design pattern, memory idiom, or safety vulnerability."""

    pattern_type: PatternType
    pattern_category: PatternCategory
    target_name: str
    target_kind: str  # "struct", "function", "module", "header", "dispatch_table"
...
class DetectionReport:
    """Aggregated findings report of a C codebase scan."""
