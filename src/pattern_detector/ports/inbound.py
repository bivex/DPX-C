"""Inbound (driver) ports for the C pattern detector application layer."""
...
@dataclass
class ScanOptions:
    """Configuration options for a C codebase scan execution."""
...
class ScannerPort(Protocol):
    """Primary inbound port for scanning C codebases and returning DetectionReports."""
...
class DetectorPort(Protocol):
    """Inbound port for executing pattern detection rules on a C CodeModel."""
